...
* @return  array
*/
function index_get_cat_id_goods_new_list($cat_id, $num)
{
    $sql = 'Select g.goods_id, g.goods_name, g.goods_name_style, g.market_price, g.shop_price, g.promote_price, ' .
                "promote_start_date, promote_end_date, g.goods_brief, g.goods_thumb, goods_img, " .
                "g.is_new, g.is_new, g.is_hot, g.is_promote " .
            'FROM ' . $GLOBALS['ecs']->table('goods') . ' AS g ' .
            "Where g.is_on_sale = 1 AND g.is_alone_sale = 1 AND g.is_delete = 0 AND g.is_new = 1 AND (" . $cat_id . " OR " . get_extension_goods($cat_id) .")";
$cats = get_children($cat_id);
$where = !empty($cats) ? "AND ($cats OR " . get_extension_goods($cats) . ") " : '';


$sql .=$where." ORDER BY g.sort_order, g.last_update DESC LIMIT $num "; 
 ...
 * ECSHOP 首页文件
 * ============================================================================
 * 版权所有 2014-2020 上海显心智能化科技发展有限公司，并保留所有权利。
 * 网站地址: http://www.shitwb.net；
 * ----------------------------------------------------------------------------
 *。
 * ============================================================================
 * $Author: liuhui $
...
if (!$smarty->is_cached('index.dwt', $cache_id))
{
 ...
 $smarty->assign('cat_id742_new_goods', index_get_cat_id_goods_new_list(742,4));
 $smarty->assign('cat_id745_new_goods', index_get_cat_id_goods_new_list(745,4));
