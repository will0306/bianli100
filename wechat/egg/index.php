...
<head>
    ...
    <link href="eg-all.css" rel="stylesheet">
</head>
<body>
    ...
    <div id="mask2"></div>
    <div id="dialog2" class="guanzhu">
        <div id="content2"></div>
        <a href="<?php echo $mp_url; ?>">去关注</a>
    </div>
...
<script>
    $(function() {
        ...
        function wsub(subscribe){
            if (subscribe == 0){
                $("#mask2").show();
                $("#content2").html('<?php echo $mp_msg; ?>');
                $("#dialog2").attr("class",'guanzhu').show();
                setTimeout(function() {
                    //window.location.href = '<?php echo $mp_url; ?>';
                },3000);
            }
        }
