...
E_D("replace into `ecs_mail_templates` values('12','goods_booking','1','缺货回复','亲爱的{\$user_name}。你好！</br></br>您提交的缺货商品为</br></br><a href=\"{\$goods_link}\" target=\"_blank\">{\$goods_name}</a></br><br>店家给您的回复：</br>{\$dispose_note}</br></br>{\$shop_name} </br>{\$send_date}','0','0','template');");
