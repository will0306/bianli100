...
E_D("replace into `ecs_cat_recommend` values('82','2');");
E_D("replace into `ecs_cat_recommend` values('125','2');");
E_D("replace into `ecs_cat_recommend` values('742','2');");
E_D("replace into `ecs_cat_recommend` values('745','2');");
